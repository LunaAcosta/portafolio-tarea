<template>
  <section class="sumario" id="sumario">
      ...
      <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-12">
              <div class="card sumario-text text-center bg-black pb-2">
                <div class="card-body">
                  ...
                  <h6>Coevaluacion - Laboratorio II - 10% </h6>
                  <hr>
                  <h5 class="text-uppercase">Semana # 6</h5>
  ...
  <section class="sumario" id="sumario">
      <div class="row">
            <!-- Card 1 -->
            <div class="col-12 col-md-12 col-lg-12 sumario-text">
